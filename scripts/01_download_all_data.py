...
1. USDA NASS QuickStats: Yield, area, production
...
Supports all crops handled by the modified data collection scripts.
"""
...
def main():
    ...
    print("=" * 80)
    print("US CROP YIELD PREDICTION - DATA DOWNLOAD PIPELINE")
    print("=" * 80)
    print()
